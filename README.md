...
<div align="center">
  <img src="./public/logo.svg" alt="TurnWeaver — Sid Meier&apos;s Civilization VI — Civilization" width="64" height="64">
  <h1>TurnWeaver — Sid Meier&apos;s Civilization VI — Civilization</h1>
</div>

An independent project specification for Sid Meier's Civilization VI, covering turn economy worksheets, technology route comparisons, ruleset compatibility notes.
...
<img src="./public/screenshots/desktop-main.svg" alt="Sid Meier&apos;s Civilization VI — desktop concept, not a screenshot" width="520">
<br>
<em>Three proposed modules, not implemented features</em>
</td>
<td align="center">
<h3>Compact Concept</h3>
<img src="./public/screenshots/mobile-overview.svg" alt="Sid Meier&apos;s Civilization VI — compact concept, not a screenshot" width="250">
<br>
...
- **Turn economy worksheets** — planned module; not implemented.
- **Technology route comparisons** — planned module; not implemented.
- **Ruleset compatibility notes** — planned module; not implemented.

The proposed workflow separates turn economy worksheets from technology route comparisons, with ruleset compatibility notes retained for reproducibility. These are design goals, not claims about existing functionality.
...
3. Describe one baseline scenario for **Turn economy worksheets**.
...
<div align="center">
<img src="./public/screenshots/review-workflow.svg" width="700" alt="TurnWeaver — Sid Meier&apos;s Civilization VI — Civilization — specification review workflow">
<br>
...
### Turn economy worksheets

Define the input and expected outcome for module 1. Record the Sid Meier's Civilization VI version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.

### Technology route comparisons

Define the input and expected outcome for module 2. Record the Sid Meier's Civilization VI version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.

### Ruleset compatibility notes

Define the input and expected outcome for module 3. Record the Sid Meier's Civilization VI version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.
...
| Planned output | Turn economy worksheets |
